 ...
 * @version 0.1
 */
require_once LIBS_DIR . 'csv-utils/Csv/Exception/CannotDetermineDialect.php';
require_once LIBS_DIR . 'csv-utils/Csv/Exception/DataSampleTooShort.php';
require_once LIBS_DIR . 'csv-utils/Csv/Reader/String.php';
/**
