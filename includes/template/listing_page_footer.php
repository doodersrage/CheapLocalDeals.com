...
//if (!class_exists('results_bottom_pg') && !empty($_SESSION['city'])) {
//	require(CLASSES_DIR.'sections/results_btm.php'); 
//	$results_bottom_pg = new results_bottom_pg;
//	$categories_bot_list = $results_bottom_pg->list_categories();
//}
?>
...
<div class="page_footer">
  <table border="0" width="900" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="100%" colspan="2" align="center" bgcolor="#537D4A"><div class="states_foot">
          <?PHP require(FUNCTIONS_DIR.'build_states.php'); ?>
        </div></td>
    </tr>
    <tr>
      <td width="100%" colspan="2" align="center" bgcolor="#537D4A"><div class="states_foot"><?PHP echo (isset($categories_bot_list) ? $categories_bot_list : ''); ?></div></td>
    </tr>
    <tr>
          ...
          <tr>
            <td width="100%"><table border="0" align="center" cellpadding="5" cellspacing="5">
                <tr>
                  ...
                  <td><a href="<?PHP echo SITE_URL; ?>rss.deal?zip=<?PHP echo (isset($_SESSION['cur_zip']) ? $_SESSION['cur_zip'] : ''); ?>&city=<?PHP echo (isset($_SESSION['city']) ? $_SESSION['city'] : ''); ?>" target="_blank"><img alt="Cheap Local Deals RSS Feed" border="0" width="28" height="28" src="images/rss_feed.jpg" /></a></td>
                  <td><a href="http://www.instantssl.com" rel="nofollow"> <img src="images/horz_master_85pixels.gif" alt="SSl" width="85" height="51" /></a></td>
                </tr>
              </table></td>
          </tr>
        </table></td>
