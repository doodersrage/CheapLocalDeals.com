...
if (!class_exists('change_advertiser_password_pg')) {
	require(CLASSES_DIR.'pages/change_advertiser_password.php');
	$change_advertiser_password_pg = new change_advertiser_password_pg;
}

if ($_SESSION['advertiser_logged_in'] != 1) {
	header("Location: ".SITE_SSL_URL."advertiser_admin/advertiser_login.deal");			
} else {
	$page_output .= $change_advertiser_password_pg->draw_change_password_form();
}
