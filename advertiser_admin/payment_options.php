...
//			$states_dd .= '<option value="'.$cur_state['acn'].'" '.($cur_state['acn'] == $adv_info_tbl->bank_state ? 'selected="selected" ' : '').'>'.$cur_state['state'].'</option>';
//		}
//
//	$page_output .= '<tr><td class="frn_conbox" align="right">Bank State:</td><td class="frn_conbox" align="left"><select name="bank_state">'.$states_dd.'</select></td></tr>';
...
//		$rows = $dbh->queryAll($sql_query);
//		foreach($rows as $cur_state) {
//			$states_dd .= '<option value="'.$cur_state['acn'].'" '.($cur_state['acn'] == $adv_info_tbl->drivers_license_state ? 'selected="selected" ' : '').'>'.$cur_state['state'].'</option>';
//		}
//
//	$page_output .= '<tr><td class="frn_conbox" align="right">Drivers License State:</td><td class="frn_conbox" align="left"><select name="drivers_license_state">'.$states_dd.'</select></td></tr>';
//	$page_output .= '</table>';
